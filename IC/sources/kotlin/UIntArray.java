...
public final class UIntArray implements Collection<UInt>, KMappedMarker {
    ...
    public static final /* synthetic */ UIntArray m170boximpl(int[] iArr) {
        return new UIntArray(iArr);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int[] m172constructorimpl(int[] iArr) {
    ...
    public static boolean m175equalsimpl(int[] iArr, Object obj) {
        return (obj instanceof UIntArray) && Intrinsics.areEqual((Object) iArr, (Object) ((UIntArray) obj).m186unboximpl());
    }
    ...
    public boolean m184addWZ4Q5Ns(int i) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public static int[] m171constructorimpl(int i) {
        return m172constructorimpl(new int[i]);
    }

    /* renamed from: get-pVg5ArA  reason: not valid java name */
    public static final int m177getpVg5ArA(int[] iArr, int i) {
        return UInt.m118constructorimpl(iArr[i]);
    }

    /* renamed from: set-VXSXFK8  reason: not valid java name */
    public static final void m182setVXSXFK8(int[] iArr, int i, int i2) {
        iArr[i] = i2;
    }
    ...
    private static final class Iterator extends UIntIterator {
        ...
        public int m187nextUIntpVg5ArA() {
            int i = this.index;
            int[] iArr = this.array;
            if (i < iArr.length) {
                this.index = i + 1;
    ...
    public boolean m185containsWZ4Q5Ns(int i) {
        return m173containsWZ4Q5Ns(this.storage, i);
    }

    /* renamed from: contains-WZ4Q5Ns  reason: not valid java name */
    public static boolean m173containsWZ4Q5Ns(int[] iArr, int i) {
    ...
    public static boolean m174containsAllimpl(int[] iArr, Collection<UInt> collection) {
        boolean z;
        Intrinsics.checkNotNullParameter(collection, "elements");
        Iterable iterable = collection;
        if (!((Collection) iterable).isEmpty()) {
            for (Object next : iterable) {
                if (!(next instanceof UInt) || !ArraysKt.contains(iArr, ((UInt) next).m169unboximpl())) {
                    z = false;
                    continue;
                } else {
                    z = true;
