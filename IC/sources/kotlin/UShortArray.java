...
public final class UShortArray implements Collection<UShort>, KMappedMarker {
    ...
    public static final /* synthetic */ UShortArray m352boximpl(short[] sArr) {
        return new UShortArray(sArr);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static short[] m354constructorimpl(short[] sArr) {
    ...
    public static boolean m357equalsimpl(short[] sArr, Object obj) {
        return (obj instanceof UShortArray) && Intrinsics.areEqual((Object) sArr, (Object) ((UShortArray) obj).m368unboximpl());
    }
    ...
    public boolean m366addxj2QHRw(short s) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    /* renamed from: constructor-impl  reason: not valid java name */
    public static short[] m353constructorimpl(int i) {
        return m354constructorimpl(new short[i]);
    }

    /* renamed from: get-Mh2AYeg  reason: not valid java name */
    public static final short m359getMh2AYeg(short[] sArr, int i) {
        return UShort.m302constructorimpl(sArr[i]);
    }

    /* renamed from: set-01HTLdE  reason: not valid java name */
    public static final void m364set01HTLdE(short[] sArr, int i, short s) {
        sArr[i] = s;
    }
    ...
    private static final class Iterator extends UShortIterator {
        ...
        public short m369nextUShortMh2AYeg() {
            int i = this.index;
    ...
    public boolean m367containsxj2QHRw(short s) {
        return m355containsxj2QHRw(this.storage, s);
    }

    /* renamed from: contains-xj2QHRw  reason: not valid java name */
    public static boolean m355containsxj2QHRw(short[] sArr, short s) {
    ...
    public static boolean m356containsAllimpl(short[] sArr, Collection<UShort> collection) {
        boolean z;
        Intrinsics.checkNotNullParameter(collection, "elements");
        Iterable iterable = collection;
        if (!((Collection) iterable).isEmpty()) {
            for (Object next : iterable) {
                if (!(next instanceof UShort) || !ArraysKt.contains(sArr, ((UShort) next).m351unboximpl())) {
                    z = false;
                    continue;
                } else {
                    z = true;
