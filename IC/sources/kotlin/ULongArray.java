...
public final class ULongArray implements Collection<ULong>, KMappedMarker {
    ...
    public static final /* synthetic */ ULongArray m248boximpl(long[] jArr) {
        return new ULongArray(jArr);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static long[] m250constructorimpl(long[] jArr) {
    ...
    public static boolean m253equalsimpl(long[] jArr, Object obj) {
        return (obj instanceof ULongArray) && Intrinsics.areEqual((Object) jArr, (Object) ((ULongArray) obj).m264unboximpl());
    }
    ...
    public boolean m262addVKZWuLQ(long j) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    /* renamed from: constructor-impl  reason: not valid java name */
    public static long[] m249constructorimpl(int i) {
        return m250constructorimpl(new long[i]);
    }

    /* renamed from: get-s-VKNKU  reason: not valid java name */
    public static final long m255getsVKNKU(long[] jArr, int i) {
        return ULong.m196constructorimpl(jArr[i]);
    }

    /* renamed from: set-k8EXiF4  reason: not valid java name */
    public static final void m260setk8EXiF4(long[] jArr, int i, long j) {
        jArr[i] = j;
    }
    ...
    private static final class Iterator extends ULongIterator {
        ...
        public long m265nextULongsVKNKU() {
            int i = this.index;
    ...
    public boolean m263containsVKZWuLQ(long j) {
        return m251containsVKZWuLQ(this.storage, j);
    }

    /* renamed from: contains-VKZWuLQ  reason: not valid java name */
    public static boolean m251containsVKZWuLQ(long[] jArr, long j) {
    ...
    public static boolean m252containsAllimpl(long[] jArr, Collection<ULong> collection) {
        boolean z;
        Intrinsics.checkNotNullParameter(collection, "elements");
        Iterable iterable = collection;
        if (!((Collection) iterable).isEmpty()) {
            for (Object next : iterable) {
                if (!(next instanceof ULong) || !ArraysKt.contains(jArr, ((ULong) next).m247unboximpl())) {
                    z = false;
                    continue;
                } else {
                    z = true;
