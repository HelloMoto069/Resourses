...
public final class TestTimeSource extends AbstractLongTimeSource {
    ...
    public final void m1438plusAssignLRDsOJo(long j) {
        long j2;
        long r0 = Duration.m1356toLongimpl(j, getUnit());
        if (r0 == Long.MIN_VALUE || r0 == Long.MAX_VALUE) {
            double r2 = ((double) this.reading) + Duration.m1353toDoubleimpl(j, getUnit());
            if (r2 > 9.223372036854776E18d || r2 < -9.223372036854776E18d) {
                m1437overflowLRDsOJo(j);
            }
            j2 = (long) r2;
        } else {
    ...
    private final void m1437overflowLRDsOJo(long j) {
