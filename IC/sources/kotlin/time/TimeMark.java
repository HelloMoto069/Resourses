...
public abstract class TimeMark {
    ...
    public abstract long m1439elapsedNowUwyO8pc();

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1441plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this, j, (DefaultConstructorMarker) null);
    }

    /* renamed from: minus-LRDsOJo  reason: not valid java name */
    public TimeMark m1440minusLRDsOJo(long j) {
        return m1441plusLRDsOJo(Duration.m1362unaryMinusUwyO8pc(j));
    }

    public final boolean hasPassedNow() {
        return !Duration.m1343isNegativeimpl(m1439elapsedNowUwyO8pc());
    }
