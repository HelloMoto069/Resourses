...
final class AdjustedTimeMark extends TimeMark {
    ...
    public final long m1304getAdjustmentUwyO8pc() {
    ...
    public long m1303elapsedNowUwyO8pc() {
        return Duration.m1345minusLRDsOJo(this.mark.m1439elapsedNowUwyO8pc(), m1304getAdjustmentUwyO8pc());
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1305plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m1346plusLRDsOJo(m1304getAdjustmentUwyO8pc(), j), (DefaultConstructorMarker) null);
    }
}
