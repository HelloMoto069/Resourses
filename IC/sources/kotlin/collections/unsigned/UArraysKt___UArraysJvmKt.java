...
class UArraysKt___UArraysJvmKt {
    ...
    private static final int m501elementAtqFRl0hI(int[] iArr, int i) {
        ...
        return UIntArray.m177getpVg5ArA(iArr, i);
    }
    ...
    private static final long m502elementAtr7IrZao(long[] jArr, int i) {
        ...
        return ULongArray.m255getsVKNKU(jArr, i);
    }
    ...
    public static /* synthetic */ int m492binarySearch2fe2U9s$default(int[] iArr, int i, int i2, int i3, int i4, Object obj) {
        ...
        if ((i4 & 4) != 0) {
            i3 = UIntArray.m178getSizeimpl(iArr);
        }
        return UArraysKt.m491binarySearch2fe2U9s(iArr, i, i2, i3);
    }
    ...
    public static final int m491binarySearch2fe2U9s(int[] iArr, int i, int i2, int i3) {
        ...
        AbstractList.Companion.checkRangeIndexes$kotlin_stdlib(i2, i3, UIntArray.m178getSizeimpl(iArr));
        int i4 = i3 - 1;
        while (i2 <= i4) {
            int i5 = (i2 + i4) >>> 1;
    ...
    public static /* synthetic */ int m496binarySearchK6DWlUc$default(long[] jArr, long j, int i, int i2, int i3, Object obj) {
        ...
        if ((i3 & 4) != 0) {
            i2 = ULongArray.m256getSizeimpl(jArr);
        }
        return UArraysKt.m495binarySearchK6DWlUc(jArr, j, i, i2);
    }
    ...
    public static final int m495binarySearchK6DWlUc(long[] jArr, long j, int i, int i2) {
        ...
        AbstractList.Companion.checkRangeIndexes$kotlin_stdlib(i, i2, ULongArray.m256getSizeimpl(jArr));
        int i3 = i2 - 1;
        while (i <= i3) {
            int i4 = (i + i3) >>> 1;
    ...
    public static /* synthetic */ int m498binarySearchWpHrYlw$default(byte[] bArr, byte b, int i, int i2, int i3, Object obj) {
        ...
        return UArraysKt.m497binarySearchWpHrYlw(bArr, b, i, i2);
    }
    ...
    public static /* synthetic */ int m494binarySearchEtDCXyQ$default(short[] sArr, short s, int i, int i2, int i3, Object obj) {
        ...
        return UArraysKt.m493binarySearchEtDCXyQ(sArr, s, i, i2);
    }
    ...
    private static final BigDecimal sumOfBigDecimal(int[] iArr, Function1<? super UInt, ? extends BigDecimal> function1) {
        ...
        int r1 = UIntArray.m178getSizeimpl(iArr);
        for (int i = 0; i < r1; i++) {
            valueOf = valueOf.add((BigDecimal) function1.invoke(UInt.m112boximpl(UIntArray.m177getpVg5ArA(iArr, i))));
    ...
    private static final BigDecimal sumOfBigDecimal(long[] jArr, Function1<? super ULong, ? extends BigDecimal> function1) {
        ...
        BigDecimal valueOf = BigDecimal.valueOf(0);
        Intrinsics.checkNotNullExpressionValue(valueOf, "valueOf(this.toLong())");
        int r1 = ULongArray.m256getSizeimpl(jArr);
        for (int i = 0; i < r1; i++) {
            valueOf = valueOf.add((BigDecimal) function1.invoke(ULong.m190boximpl(ULongArray.m255getsVKNKU(jArr, i))));
            Intrinsics.checkNotNullExpressionValue(valueOf, "this.add(other)");
        }
        return valueOf;
    }
    ...
    private static final BigDecimal sumOfBigDecimal(byte[] bArr, Function1<? super UByte, ? extends BigDecimal> function1) {
        ...
        for (int i = 0; i < r1; i++) {
            valueOf = valueOf.add((BigDecimal) function1.invoke(UByte.m36boximpl(UByteArray.m99getw2LRezQ(bArr, i))));
            Intrinsics.checkNotNullExpressionValue(valueOf, "this.add(other)");
        }
        return valueOf;
    }
    ...
    private static final BigDecimal sumOfBigDecimal(short[] sArr, Function1<? super UShort, ? extends BigDecimal> function1) {
        ...
        for (int i = 0; i < r1; i++) {
            valueOf = valueOf.add((BigDecimal) function1.invoke(UShort.m296boximpl(UShortArray.m359getMh2AYeg(sArr, i))));
            Intrinsics.checkNotNullExpressionValue(valueOf, "this.add(other)");
        }
        return valueOf;
    }
    ...
    private static final BigInteger sumOfBigInteger(int[] iArr, Function1<? super UInt, ? extends BigInteger> function1) {
        ...
        int r1 = UIntArray.m178getSizeimpl(iArr);
        for (int i = 0; i < r1; i++) {
            valueOf = valueOf.add((BigInteger) function1.invoke(UInt.m112boximpl(UIntArray.m177getpVg5ArA(iArr, i))));
            Intrinsics.checkNotNullExpressionValue(valueOf, "this.add(other)");
        }
        return valueOf;
    }
    ...
    private static final BigInteger sumOfBigInteger(long[] jArr, Function1<? super ULong, ? extends BigInteger> function1) {
        ...
        int r1 = ULongArray.m256getSizeimpl(jArr);
        for (int i = 0; i < r1; i++) {
            valueOf = valueOf.add((BigInteger) function1.invoke(ULong.m190boximpl(ULongArray.m255getsVKNKU(jArr, i))));
            Intrinsics.checkNotNullExpressionValue(valueOf, "this.add(other)");
        }
        return valueOf;
    }
    ...
    private static final BigInteger sumOfBigInteger(byte[] bArr, Function1<? super UByte, ? extends BigInteger> function1) {
        ...
        int r1 = UByteArray.m100getSizeimpl(bArr);
        for (int i = 0; i < r1; i++) {
            valueOf = valueOf.add((BigInteger) function1.invoke(UByte.m36boximpl(UByteArray.m99getw2LRezQ(bArr, i))));
            Intrinsics.checkNotNullExpressionValue(valueOf, "this.add(other)");
        }
        return valueOf;
    }
    ...
    private static final BigInteger sumOfBigInteger(short[] sArr, Function1<? super UShort, ? extends BigInteger> function1) {
        ...
        int r1 = UShortArray.m360getSizeimpl(sArr);
        for (int i = 0; i < r1; i++) {
            valueOf = valueOf.add((BigInteger) function1.invoke(UShort.m296boximpl(UShortArray.m359getMh2AYeg(sArr, i))));
            Intrinsics.checkNotNullExpressionValue(valueOf, "this.add(other)");
        }
        return valueOf;
    }
