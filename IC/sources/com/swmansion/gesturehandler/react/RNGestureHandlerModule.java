...
public class RNGestureHandlerModule extends ReactContextBaseJavaModule {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:20:0x004a, code lost:
        if (r5.mEnqueuedRootViewInit.contains(java.lang.Integer.valueOf(r1)) == false) goto L_0x004e;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:25:0x0058, code lost:
        r0.addUIBlock(new com.swmansion.gesturehandler.react.RNGestureHandlerModule.AnonymousClass2(r5));
     */
    /* JADX WARNING: Code restructure failed: missing block: B:26:0x0060, code lost:
        return;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void tryInitializeHandlerForReactRootView(int r6) {
        /*
            r5 = this;
            ...
            java.util.List<com.swmansion.gesturehandler.react.RNGestureHandlerRootHelper> r2 = r5.mRoots
            monitor-enter(r2)
            r6 = 0
        L_0x0017:
            java.util.List<com.swmansion.gesturehandler.react.RNGestureHandlerRootHelper> r3 = r5.mRoots     // Catch:{ all -> 0x0064 }
            int r3 = r3.size()     // Catch:{ all -> 0x0064 }
            if (r6 >= r3) goto L_0x003c
            java.util.List<com.swmansion.gesturehandler.react.RNGestureHandlerRootHelper> r3 = r5.mRoots     // Catch:{ all -> 0x0064 }
            java.lang.Object r3 = r3.get(r6)     // Catch:{ all -> 0x0064 }
            com.swmansion.gesturehandler.react.RNGestureHandlerRootHelper r3 = (com.swmansion.gesturehandler.react.RNGestureHandlerRootHelper) r3     // Catch:{ all -> 0x0064 }
            android.view.ViewGroup r3 = r3.getRootView()     // Catch:{ all -> 0x0064 }
            boolean r4 = r3 instanceof com.facebook.react.ReactRootView     // Catch:{ all -> 0x0064 }
            if (r4 == 0) goto L_0x0039
            com.facebook.react.ReactRootView r3 = (com.facebook.react.ReactRootView) r3     // Catch:{ all -> 0x0064 }
            int r3 = r3.getRootViewTag()     // Catch:{ all -> 0x0064 }
        ...
        L_0x003c:
            monitor-exit(r2)     // Catch:{ all -> 0x0064 }
            java.util.List<java.lang.Integer> r6 = r5.mEnqueuedRootViewInit
            monitor-enter(r6)
            java.util.List<java.lang.Integer> r2 = r5.mEnqueuedRootViewInit     // Catch:{ all -> 0x0061 }
            java.lang.Integer r3 = java.lang.Integer.valueOf(r1)     // Catch:{ all -> 0x0061 }
            boolean r2 = r2.contains(r3)     // Catch:{ all -> 0x0061 }
        ...
        L_0x004e:
            ...
            monitor-exit(r6)     // Catch:{ all -> 0x0061 }
            com.swmansion.gesturehandler.react.RNGestureHandlerModule$2 r6 = new com.swmansion.gesturehandler.react.RNGestureHandlerModule$2
            r6.<init>(r1)
            r0.addUIBlock(r6)
            return
        L_0x0061:
