...
public final class ScreensShadowNode extends LayoutShadowNode {
        ...
        if (uIManagerModule != null) {
            uIManagerModule.addUIBlock(new UIBlock() {
                public final void execute(NativeViewHierarchyManager nativeViewHierarchyManager) {
                    ScreensShadowNode.m14onBeforeLayout$lambda0(ScreensShadowNode.this, nativeViewHierarchyManager);
                }
            });
        }
    }
    ...
    public static final void m14onBeforeLayout$lambda0(ScreensShadowNode screensShadowNode, NativeViewHierarchyManager nativeViewHierarchyManager) {
