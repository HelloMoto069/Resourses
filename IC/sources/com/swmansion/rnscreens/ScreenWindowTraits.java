...
public final class ScreenWindowTraits {
    ...
    public final void setStyle$react_native_screens_release(Screen screen, Activity activity, ReactContext reactContext) {
        ...
        if (activity != null && reactContext != null && Build.VERSION.SDK_INT >= 23) {
            ...
            UiThreadUtil.runOnUiThread(new Runnable(activity, str) {
                ...
                public final void run() {
                    ScreenWindowTraits.m9setStyle$lambda0(this.f$0, this.f$1);
                }
            });
        }
    }
    ...
    public static final void m9setStyle$lambda0(Activity activity, String str) {
    ...
    public final void setHidden$react_native_screens_release(com.swmansion.rnscreens.Screen r3, android.app.Activity r4) {
        ...
        L_0x001c:
            ...
            r0.<init>(r4, r1)
            com.swmansion.rnscreens.-$$Lambda$ScreenWindowTraits$gjsvvvQMK_CLF239gSdgnep4CEg r4 = new com.swmansion.rnscreens.-$$Lambda$ScreenWindowTraits$gjsvvvQMK_CLF239gSdgnep4CEg
            r4.<init>(r3, r0)
    ...
    public static final void m7setHidden$lambda1(boolean z, WindowInsetsControllerCompat windowInsetsControllerCompat) {
    ...
    public final void setNavigationBarColor$react_native_screens_release(com.swmansion.rnscreens.Screen r2, android.app.Activity r3) {
        ...
        L_0x0023:
            com.swmansion.rnscreens.-$$Lambda$ScreenWindowTraits$j2wkvcNLhwZw768Bho60WLki5LI r0 = new com.swmansion.rnscreens.-$$Lambda$ScreenWindowTraits$j2wkvcNLhwZw768Bho60WLki5LI
            r0.<init>(r3, r2)
            com.facebook.react.bridge.UiThreadUtil.runOnUiThread(r0)
    ...
    public static final void m8setNavigationBarColor$lambda2(Window window, int i) {
