...
public final class SearchBarView extends ReactViewGroup {
    ...
    private final void setSearchViewListeners(SearchView searchView) {
        ...
        searchView.setOnQueryTextFocusChangeListener(new View.OnFocusChangeListener() {
            public final void onFocusChange(View view, boolean z) {
                SearchBarView.m17setSearchViewListeners$lambda0(SearchBarView.this, view, z);
            }
        });
        searchView.setOnCloseListener(new SearchView.OnCloseListener() {
            public final boolean onClose() {
                return SearchBarView.m18setSearchViewListeners$lambda1(SearchBarView.this);
            }
        });
        searchView.setOnSearchClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                SearchBarView.m19setSearchViewListeners$lambda2(SearchBarView.this, view);
            }
        });
    }
    ...
    public static final void m17setSearchViewListeners$lambda0(SearchBarView searchBarView, View view, boolean z) {
    ...
    public static final boolean m18setSearchViewListeners$lambda1(SearchBarView searchBarView) {
        Intrinsics.checkNotNullParameter(searchBarView, "this$0");
    ...
    public static final void m19setSearchViewListeners$lambda2(SearchBarView searchBarView, View view) {
        Intrinsics.checkNotNullParameter(searchBarView, "this$0");
