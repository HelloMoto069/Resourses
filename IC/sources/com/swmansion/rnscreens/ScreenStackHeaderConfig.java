...
public final class ScreenStackHeaderConfig extends ViewGroup {
    ...
    private final View.OnClickListener mBackClickListener = new View.OnClickListener() {
        public final void onClick(View view) {
            ScreenStackHeaderConfig.m6mBackClickListener$lambda1(ScreenStackHeaderConfig.this, view);
        }
    };
    ...
    public static final void m6mBackClickListener$lambda1(ScreenStackHeaderConfig screenStackHeaderConfig, View view) {
                    ...
                    if (supportActionBar != null) {
                        ...
                        if (titleTextView != null) {
                            ...
                            if (str2 != null || this.mTitleFontWeight > 0) {
                                titleTextView.setTypeface(ReactTypefaceUtils.applyStyles((Typeface) null, 0, this.mTitleFontWeight, str2, getContext().getAssets()));
                            }
