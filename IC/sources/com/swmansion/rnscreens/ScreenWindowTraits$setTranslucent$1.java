...
public final class ScreenWindowTraits$setTranslucent$1 extends GuardedRunnable {
    ...
    public void runGuarded() {
        ...
        if (this.$translucent) {
            ViewCompat.setOnApplyWindowInsetsListener(decorView, $$Lambda$ScreenWindowTraits$setTranslucent$1$Dz1cYykidIujSb9SX8lnwFat4Yk.INSTANCE);
        } else {
    ...
    public static final WindowInsetsCompat m12runGuarded$lambda0(View view, WindowInsetsCompat windowInsetsCompat) {
