...
abstract class DateFormatTextWatcher implements TextWatcher {
    ...
    public void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
        ...
        try {
            ...
            textInputLayout2.setError(string + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE + format + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE + format2);
            onInvalidDate();
        }
    }
}
