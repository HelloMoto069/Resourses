...
public class ApplicationWrapper extends Application {
    ...
    public void onCreate() {
        try {
            ...
            boolean sandboxExternalStorage = applicationInfo.metaData.getBoolean("com.applisto.appcloner.sandboxExternalStorage");
            String str = TAG;
    ...
    private Application createApplication(ApplicationInfo applicationInfo) throws Exception {
        String applicationClassName = applicationInfo.metaData.getString("com.applisto.appcloner.applicationClassName", "android.app.Application");
        String str = TAG;
